 						...
 						<?php if (!empty($row)) { ?>
 							<?php foreach ($row as $r) : ?>
 								<tr>
                                    ...
                                    <td><a a style="color:black;" href="?f=admin&m=delete&id=<?php echo $r['f_id'] ?>"><button type="button" class="btn btn-outline-danger red" onclick="return confirm('Are you sure?');">Delete</button></a></td>
 								</tr>
 							<?php endforeach ?>
 						<?php } ?>
 					</tbody>

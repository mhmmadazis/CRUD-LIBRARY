        ...
        if (!empty($row)) { ?>
            <?php foreach ($row as $r) : ?>
                <tr>
                    ...
                    <td><a href="?f=pengembalian&m=delete&id=<?php echo $r['idpengembalian'] ?>"><button type="button" class="btn btn-outline-dark del" style="border: 1px solid red; color: ;" onclick="return confirm('Are you sure?');">Delete</button></a></td>
                </tr>
            <?php endforeach ?>
        <?php } ?>
    </tbody>

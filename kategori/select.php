                        ...
                        <?php if (!empty($row)) { ?>
                            <?php foreach ($row as $r) : ?>
                                <tr>
                                    ...
                                    <td><a style="color:;" href="?f=kategori&m=delete&id=<?php echo $r['f_id'] ?>"><button type="button" class="btn btn-outline-danger" onclick="return confirm('Are you sure?');">Delete</button></a></td>
                                </tr>
                            <?php endforeach ?>
                        <?php } ?>
                    </tbody>
